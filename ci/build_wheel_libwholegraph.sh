...
rapids-dependency-file-generator \
  --output requirements \
  --file-key "py_build_libwholegraph" \
  --file-key "py_rapids_build_libwholegraph" \
...
rapids-logger "Done installing build requirements"
...
RAPIDS_PACKAGE_NAME="$(rapids-artifact-name wheel_cpp libwholegraph cugraph-gnn --cuda "$RAPIDS_CUDA_VERSION")"
